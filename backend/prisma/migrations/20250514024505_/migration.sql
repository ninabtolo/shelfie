...
-- CreateIndex
CREATE UNIQUE INDEX "_ReadingList_AB_unique" ON "_ReadingList"("A", "B");

-- CreateIndex
CREATE INDEX "_ReadingList_B_index" ON "_ReadingList"("B");
...
-- AddForeignKey
ALTER TABLE "_ReadingList" ADD CONSTRAINT "_ReadingList_A_fkey" FOREIGN KEY ("A") REFERENCES "Book"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ReadingList" ADD CONSTRAINT "_ReadingList_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
